...
#>   ..$ imag1: int [1:250] 9 6 8 6 8 8 7 8 5 8 ...
#>   ..$ imag2: int [1:250] 9 8 9 6 8 7 9 8 8 8 ...
#>   ..$ imag3: int [1:250] 9 8 9 6 8 8 9 8 8 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 10 10 9 8 5 5 8 8 8 7 ...
#>   ..$ imag2: int [1:250] 10 10 10 5 9 5 5 8 8 5 ...
#>   ..$ imag3: int [1:250] 10 10 9 7 10 5 9 8 9 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 7 5 8 7 10 8 7 8 9 ...
#>   ..$ imag2: int [1:250] 9 7 5 8 8 10 9 9 7 5 ...
#>   ..$ imag3: int [1:250] 9 7 5 8 8 10 9 9 8 6 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.901 -1.261 -0.279 1.117 0.486 ...
#>   .. ..$ x2   : num [1:10] -0.405 -1.649 2.196 -1.152 -0.462 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.9618 0.611 -0.0887 0.452 -0.1524 ...
#>   .. ..$ x2   : num [1:10] -0.03251 -1.40525 -1.38825 -0.00514 2.01131 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0749 -0.735 -0.4682 -0.7827 1.1772 ...
#>   .. ..$ x2   : num [1:10] -0.81 -0.331 -0.536 -0.205 0.529 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.2613 -1.3344 -0.0887 1.1772 1.3766 ...
#>   .. ..$ x2   : num [1:10] -1.649 -1.814 -1.388 0.529 1.092 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.264 0.619 -0.084 1.779 -0.628 ...
#>   .. ..$ x2   : num [1:10] -1.196 0.314 -0.708 -1.094 0.736 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.735 -0.0469 1.8714 -0.4636 -0.773 ...
#>   .. ..$ x2   : num [1:10] -0.331 1.366 -1.049 -0.535 0.536 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.946 -0.779 -0.783 -0.686 1.871 ...
#>   .. ..$ x2   : num [1:10] 0.47 0.975 -0.205 -0.982 -1.049 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0062 -0.628 0.8539 0.34 1.1762 ...
#>   .. ..$ x2   : num [1:10] 1.845 0.736 -0.99 -0.972 -0.126 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.7637 0.6637 1.1772 1.7787 -0.0887 ...
#>   .. ..$ x2   : num [1:10] 0.37 -0.113 0.529 -1.094 -1.388 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (27cfb7afadfa3f735e8f033a5f028647-15); on 27cfb7afadfa3f735e8f033a5f028647@runnervm7i58z<6957>]
