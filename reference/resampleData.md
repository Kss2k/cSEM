...
#>   ..$ imag1: int [1:250] 8 10 8 8 10 10 10 8 6 8 ...
#>   ..$ imag2: int [1:250] 8 10 6 9 10 10 10 8 8 9 ...
#>   ..$ imag3: int [1:250] 10 10 9 5 10 10 10 8 8 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 0 8 5 9 8 9 9 8 8 4 ...
#>   ..$ imag2: int [1:250] 4 6 5 10 9 8 9 8 8 5 ...
#>   ..$ imag3: int [1:250] 7 3 5 9 9 9 10 8 8 5 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 5 8 8 4 5 7 9 10 8 9 ...
#>   ..$ imag2: int [1:250] 9 8 8 5 5 7 9 10 9 9 ...
#>   ..$ imag3: int [1:250] 10 10 8 5 7 7 10 9 9 10 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -1.277 -0.464 0.496 0.611 0.903 ...
#>   .. ..$ x2   : num [1:10] -1.472 -0.535 1.373 -1.405 2.454 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.334 -0.375 -0.901 -1.261 0.794 ...
#>   .. ..$ x2   : num [1:10] -1.814 -0.868 -0.405 -1.649 0.362 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.377 1.871 -0.768 -0.559 0.206 ...
#>   .. ..$ x2   : num [1:10] 1.09 -1.05 -2.1 -1.39 1.9 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.093 -2.348 0.852 1.177 -1.261 ...
#>   .. ..$ x2   : num [1:10] 0.892 -0.341 -0.947 0.529 -1.649 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.79 0.412 0.619 -0.755 1.871 ...
#>   .. ..$ x2   : num [1:10] 1.2269 -0.0186 0.3142 0.4895 -1.049 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.08454 1.64647 0.00705 0.20637 -0.76617 ...
#>   .. ..$ x2   : num [1:10] 0.786 -0.973 0.879 1.901 -0.386 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.452 -0.62 -0.766 -0.084 0.419 ...
#>   .. ..$ x2   : num [1:10] -0.00514 -1.57014 -0.38586 -0.70761 0.21181 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.184 0.634 0.603 1.177 0.962 ...
#>   .. ..$ x2   : num [1:10] 2.3755 0.9703 0.4491 0.529 -0.0325 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0841 -0.628 -0.6652 0.0845 -0.4889 ...
#>   .. ..$ x2   : num [1:10] -3.311 0.736 0.96 0.786 0.709 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (bb19ab3f80ad2ecf7d72330525360c28-17); on bb19ab3f80ad2ecf7d72330525360c28@runnervmvrwv9<7148>]
