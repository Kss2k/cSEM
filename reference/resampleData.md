...
#>   ..$ imag1: int [1:250] 8 8 7 7 8 5 7 5 9 5 ...
#>   ..$ imag2: int [1:250] 7 8 7 7 8 5 7 7 10 7 ...
#>   ..$ imag3: int [1:250] 8 10 8 8 8 7 6 8 9 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 2 9 5 8 10 5 4 7 9 5 ...
#>   ..$ imag2: int [1:250] 2 9 7 8 10 7 1 7 9 7 ...
#>   ..$ imag3: int [1:250] 8 9 7 3 8 7 4 7 6 4 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 10 10 4 8 8 8 7 10 9 8 ...
#>   ..$ imag2: int [1:250] 10 10 6 8 7 8 8 10 10 5 ...
#>   ..$ imag3: int [1:250] 10 10 9 10 7 7 8 10 10 6 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.4682 -0.2303 -0.2289 0.0749 -1.0934 ...
#>   .. ..$ x2   : num [1:10] -0.536 -0.463 -1.178 -0.81 0.892 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 2.14992 -2.49484 -0.15241 -0.75246 0.00705 ...
#>   .. ..$ x2   : num [1:10] -1.829 0.923 2.011 0.463 0.879 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.185 -0.18 -2.399 -0.559 -0.901 ...
#>   .. ..$ x2   : num [1:10] -0.1608 0.1602 0.0099 -1.3884 -0.7552 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.093 -0.766 0.903 -0.755 -0.768 ...
#>   .. ..$ x2   : num [1:10] 0.892 -0.386 2.454 0.489 -2.102 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.464 0.486 -0.375 1.117 0.34 ...
#>   .. ..$ x2   : num [1:10] -0.535 -0.462 -0.868 -1.152 -0.972 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.2303 -0.1804 -0.0062 -0.5585 -0.6259 ...
#>   .. ..$ x2   : num [1:10] -0.4629 0.1602 1.8448 -1.3884 -0.0422 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.305 0.852 -0.901 -0.773 0.412 ...
#>   .. ..$ x2   : num [1:10] 0.7915 -0.9473 -0.7552 0.5359 -0.0186 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0887 -1.5677 -0.0841 -0.6203 -0.7827 ...
#>   .. ..$ x2   : num [1:10] -1.388 2.708 -3.311 -1.57 -0.205 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.596 -0.152 1.779 0.419 -1.428 ...
#>   .. ..$ x2   : num [1:10] 0.549 2.011 -1.094 0.212 -0.284 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (cb3142718c4f6d5ead8291dcab86d4f7-18); on cb3142718c4f6d5ead8291dcab86d4f7@runnervmvrwv9<7168>]
