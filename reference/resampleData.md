...
#>   ..$ imag1: int [1:250] 8 8 8 6 8 9 7 8 10 3 ...
#>   ..$ imag2: int [1:250] 8 8 8 7 8 6 7 8 10 4 ...
#>   ..$ imag3: int [1:250] 8 8 8 7 8 6 7 8 10 3 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 8 7 7 8 10 8 9 7 6 ...
#>   ..$ imag2: int [1:250] 9 8 8 7 8 10 9 10 10 7 ...
#>   ..$ imag3: int [1:250] 7 8 7 7 8 8 5 10 10 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 10 9 8 6 7 7 9 10 0 10 ...
#>   ..$ imag2: int [1:250] 10 10 8 5 5 7 8 10 4 10 ...
#>   ..$ imag3: int [1:250] 10 7 8 5 7 7 9 10 7 10 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.755 -0.375 0.837 0.611 -0.393 ...
#>   .. ..$ x2   : num [1:10] 0.489 -0.868 0.796 -1.405 0.499 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.397 -0.686 0.854 0.496 1.177 ...
#>   .. ..$ x2   : num [1:10] -1.911 -0.982 -0.99 1.373 0.529 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.773 -0.766 -0.626 -0.152 1.377 ...
#>   .. ..$ x2   : num [1:10] 0.5359 -0.3859 -0.0422 2.0113 1.0919 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -2.399 -2.495 -0.266 -0.755 -1.334 ...
#>   .. ..$ x2   : num [1:10] 0.0099 0.9231 0.322 0.4895 -1.8135 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.375 -0.773 -1.277 0.382 0.629 ...
#>   .. ..$ x2   : num [1:10] -0.868 0.536 -1.472 0.538 -0.14 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.903 0.184 1.377 0.41 -0.264 ...
#>   .. ..$ x2   : num [1:10] 2.45 2.38 1.09 -1.28 -1.2 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.9773 0.00705 1.18493 -0.77298 0.18368 ...
#>   .. ..$ x2   : num [1:10] 0.693 0.879 -0.161 0.536 2.375 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.452 -0.559 1.764 -0.686 -0.626 ...
#>   .. ..$ x2   : num [1:10] -0.00514 -1.38843 0.36982 -0.98192 -0.0422 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.4889 -1.5677 1.2923 -0.0479 -0.7662 ...
#>   .. ..$ x2   : num [1:10] 0.709 2.708 -0.805 -0.923 -0.386 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (1b3944e39fa0a0380b987e6d0d138aca-13); on 1b3944e39fa0a0380b987e6d0d138aca@runnervmvrwv9<7124>]
