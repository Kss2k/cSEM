...
#>   ..$ imag1: int [1:250] 8 8 10 9 10 8 8 5 6 8 ...
#>   ..$ imag2: int [1:250] 8 8 10 9 10 8 4 5 8 8 ...
#>   ..$ imag3: int [1:250] 10 8 10 9 10 8 3 5 8 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 4 3 7 6 7 9 8 9 5 6 ...
#>   ..$ imag2: int [1:250] 8 4 7 6 7 9 4 9 5 6 ...
#>   ..$ imag3: int [1:250] 8 2 6 6 8 10 3 9 7 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 8 9 9 10 7 8 3 9 8 ...
#>   ..$ imag2: int [1:250] 10 7 10 7 10 7 7 4 10 6 ...
#>   ..$ imag3: int [1:250] 10 8 10 8 8 7 10 2 7 7 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.946 -0.768 -0.084 0.79 1.176 ...
#>   .. ..$ x2   : num [1:10] 0.47 -2.102 -0.708 1.227 -0.126 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.34 -0.18 1.292 -0.242 -0.152 ...
#>   .. ..$ x2   : num [1:10] -0.972 0.16 -0.805 0.667 2.011 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0062 1.1772 -0.7525 -1.2613 -0.4889 ...
#>   .. ..$ x2   : num [1:10] 1.845 0.529 0.463 -1.649 0.709 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.185 -0.977 -1.568 -0.279 0.441 ...
#>   .. ..$ x2   : num [1:10] -0.161 0.693 2.708 2.196 0.972 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.206 0.619 0.193 -2.495 -0.714 ...
#>   .. ..$ x2   : num [1:10] 1.901 0.314 -0.61 0.923 0.74 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.261 0.382 -1.428 -0.18 0.79 ...
#>   .. ..$ x2   : num [1:10] 0.286 0.538 -0.284 0.16 1.227 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.176 0.412 -0.23 0.854 0.903 ...
#>   .. ..$ x2   : num [1:10] -0.1262 -0.0186 -0.4629 -0.9897 2.4544 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0749 0.4188 -2.3992 -0.9773 -1.2613 ...
#>   .. ..$ x2   : num [1:10] -0.8103 0.2118 0.0099 0.6931 -1.6493 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.611 -1.334 0.206 -0.242 1.234 ...
#>   .. ..$ x2   : num [1:10] -1.405 -1.814 1.901 1.066 -0.564 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (1c8a47efe05841fc60382187ded0d234-15); on 1c8a47efe05841fc60382187ded0d234@runnervmvrwv9<7155>]
...
#>   ..$ x1: num [1:100] -0.242 -0.468 -0.773 2.15 -1.334 ...
#>   ..$ x2: num [1:100] 1.066 -0.536 0.536 -1.829 -1.814 ...
#>   ..$ id: chr [1:100] "female" "female" "male" "male" ...
#>   [list output truncated]
