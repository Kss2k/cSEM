...
#>   ..$ imag1: int [1:250] 9 8 9 8 9 8 10 4 10 5 ...
#>   ..$ imag2: int [1:250] 10 8 9 9 7 8 10 6 3 9 ...
#>   ..$ imag3: int [1:250] 10 8 9 9 8 8 10 5 7 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 7 6 8 8 8 8 8 9 10 8 ...
#>   ..$ imag2: int [1:250] 7 6 8 8 5 8 6 9 10 9 ...
#>   ..$ imag3: int [1:250] 8 4 8 8 6 9 6 10 10 5 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 7 8 8 5 4 9 8 8 8 8 ...
#>   ..$ imag2: int [1:250] 7 6 7 5 8 7 7 5 8 8 ...
#>   ..$ imag3: int [1:250] 7 6 7 7 8 8 6 9 8 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.634 0.596 -0.768 -0.319 0.962 ...
#>   .. ..$ x2   : num [1:10] 0.9703 0.5492 -2.1022 -0.5012 -0.0325 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.412 0.193 0.852 -1.334 0.903 ...
#>   .. ..$ x2   : num [1:10] -0.0186 -0.6105 -0.9473 -1.8135 2.4544 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.163 -0.264 1.646 1.292 0.34 ...
#>   .. ..$ x2   : num [1:10] -0.576 -1.196 -0.973 -0.805 -0.972 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.79 -0.665 0.3 0.163 -0.946 ...
#>   .. ..$ x2   : num [1:10] 1.227 0.96 1.797 -0.576 0.47 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.752 -0.375 -0.783 -0.468 0.496 ...
#>   .. ..$ x2   : num [1:10] 0.463 -0.868 -0.205 -0.536 1.373 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.62 -0.773 -0.23 0.486 1.117 ...
#>   .. ..$ x2   : num [1:10] -1.57 0.536 -0.463 -0.462 -1.152 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.4636 0.7902 0.3821 0.0749 -0.0887 ...
#>   .. ..$ x2   : num [1:10] -0.535 1.227 0.538 -0.81 -1.388 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.452 -0.4889 0.0845 -0.6203 -0.0469 ...
#>   .. ..$ x2   : num [1:10] -0.00514 0.70895 0.78559 -1.57014 1.36578 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.779 0.163 -0.229 -0.242 -0.559 ...
#>   .. ..$ x2   : num [1:10] 0.975 -0.576 -1.178 0.667 -1.388 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (cfe26d0f5525dc2820414fd9f4b4393a-15); on cfe26d0f5525dc2820414fd9f4b4393a@runnervmvrwv9<6989>]
