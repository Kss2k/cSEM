...
#>   ..$ imag1: int [1:250] 8 10 8 6 9 8 7 9 8 8 ...
#>   ..$ imag2: int [1:250] 9 10 8 7 10 9 8 10 7 6 ...
#>   ..$ imag3: int [1:250] 9 10 8 7 9 8 8 9 8 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 10 9 7 9 8 8 8 5 8 ...
#>   ..$ imag2: int [1:250] 9 10 5 7 8 10 7 10 7 10 ...
#>   ..$ imag3: int [1:250] 10 10 7 7 8 10 7 8 4 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 6 8 10 8 10 8 8 8 10 10 ...
#>   ..$ imag2: int [1:250] 7 9 10 8 10 7 8 8 8 10 ...
#>   ..$ imag3: int [1:250] 7 9 10 9 10 8 8 8 8 10 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 1.646 0.382 -0.242 1.397 0.184 ...
#>   .. ..$ x2   : num [1:10] -0.973 0.538 0.667 -1.911 2.375 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.1516 0.611 0.0845 1.234 0.7902 ...
#>   .. ..$ x2   : num [1:10] -0.284 -1.405 0.786 -0.564 1.227 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.779 -0.783 -1.277 0.664 -0.393 ...
#>   .. ..$ x2   : num [1:10] -1.094 -0.205 -1.472 -0.113 0.499 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.266 -0.779 0.527 0.629 0.854 ...
#>   .. ..$ x2   : num [1:10] 0.322 0.975 -0.87 -0.14 -0.99 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.903 -0.18 -0.714 0.34 -0.464 ...
#>   .. ..$ x2   : num [1:10] 2.454 0.16 0.74 -0.972 -0.535 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0062 0.49587 -0.77298 -0.24169 0.00705 ...
#>   .. ..$ x2   : num [1:10] 1.845 1.373 0.536 1.066 0.879 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.6029 -1.0934 -2.3992 -0.0193 0.412 ...
#>   .. ..$ x2   : num [1:10] 0.4491 0.8925 0.0099 -0.4089 -0.0186 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.084 -0.242 -0.755 1.871 -0.766 ...
#>   .. ..$ x2   : num [1:10] -0.708 1.066 0.489 -1.049 -0.386 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.794 -0.977 -0.773 0.206 -0.783 ...
#>   .. ..$ x2   : num [1:10] 0.362 0.693 0.536 1.901 -0.205 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (25d6e761ea29817fb723bd7fe7a7abef-30); on 25d6e761ea29817fb723bd7fe7a7abef@runnervmvrwv9<7755>]
