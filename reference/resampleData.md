...
#>   ..$ imag1: int [1:250] 8 5 6 4 10 9 8 9 9 8 ...
#>   ..$ imag2: int [1:250] 8 5 8 2 10 10 8 9 9 5 ...
#>   ..$ imag3: int [1:250] 10 7 8 2 8 9 8 9 9 5 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 7 8 10 8 7 9 8 9 10 5 ...
#>   ..$ imag2: int [1:250] 9 8 10 9 9 9 10 8 10 7 ...
#>   ..$ imag3: int [1:250] 9 8 10 9 9 10 8 8 10 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 6 7 8 8 8 10 8 8 2 5 ...
#>   ..$ imag2: int [1:250] 6 10 8 8 8 10 8 9 2 7 ...
#>   ..$ imag3: int [1:250] 7 10 9 8 8 10 7 9 8 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.837 -0.393 -0.261 -0.773 1.779 ...
#>   .. ..$ x2   : num [1:10] 0.796 0.499 0.286 0.536 -1.094 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.375 1.764 0.611 0.34 -0.977 ...
#>   .. ..$ x2   : num [1:10] -0.868 0.37 -1.405 -0.972 0.693 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0845 1.1175 -0.9008 0.193 -0.735 ...
#>   .. ..$ x2   : num [1:10] 0.786 -1.152 -0.755 -0.61 -0.331 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.2657 -0.264 0.0377 -0.2607 0.8375 ...
#>   .. ..$ x2   : num [1:10] 0.322 -1.196 0.192 0.286 0.796 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.62 -0.084 0.634 0.854 0.527 ...
#>   .. ..$ x2   : num [1:10] -1.57 -0.708 0.97 -0.99 -0.87 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.9456 -0.0062 -1.2613 -0.3748 0.3003 ...
#>   .. ..$ x2   : num [1:10] 0.47 1.845 -1.649 -0.868 1.797 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.7902 0.0845 -0.0193 -0.0062 -1.5677 ...
#>   .. ..$ x2   : num [1:10] 1.227 0.786 -0.409 1.845 2.708 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.903 -1.261 -0.686 1.871 -0.375 ...
#>   .. ..$ x2   : num [1:10] 2.454 -1.649 -0.982 -1.049 -0.868 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.1849 -0.0841 -0.7555 -0.2793 -2.4948 ...
#>   .. ..$ x2   : num [1:10] -0.161 -3.311 0.489 2.196 0.923 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (4f53cf0ea5e7f5bf106c6a6eb65855cd-16); on 4f53cf0ea5e7f5bf106c6a6eb65855cd@runnervmvrwv9<7189>]
...
#>   ..$ id: chr [1:100] "female" "male" "male" "female" ...
#>  $ :'data.frame':    100 obs. of  3 variables:
#>   ..$ x1: num [1:100] -0.242 -0.468 -0.773 2.15 -1.334 ...
#>   ..$ x2: num [1:100] 1.066 -0.536 0.536 -1.829 -1.814 ...
#>   ..$ id: chr [1:100] "female" "male" "female" "male" ...
#>  $ :'data.frame':    100 obs. of  3 variables:
#>   ..$ x1: num [1:100] -0.242 -0.468 -0.773 2.15 -1.334 ...
#>   ..$ x2: num [1:100] 1.066 -0.536 0.536 -1.829 -1.814 ...
