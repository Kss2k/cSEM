...
#>   ..$ imag1: int [1:250] 4 7 8 8 7 9 8 8 9 10 ...
#>   ..$ imag2: int [1:250] 6 4 10 8 8 10 8 7 6 10 ...
#>   ..$ imag3: int [1:250] 8 5 9 8 8 9 9 7 6 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 5 6 9 7 9 9 10 7 8 10 ...
#>   ..$ imag2: int [1:250] 5 7 8 7 9 10 10 7 5 8 ...
#>   ..$ imag3: int [1:250] 5 7 8 8 7 9 10 8 7 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 6 8 8 8 7 5 10 9 10 10 ...
#>   ..$ imag2: int [1:250] 6 8 9 7 8 4 10 8 8 10 ...
#>   ..$ imag3: int [1:250] 7 8 9 8 8 4 10 8 8 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 1.38 1.23 -1.09 1.78 1.65 ...
#>   .. ..$ x2   : num [1:10] 1.092 -0.564 0.892 -1.094 -0.973 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.6193 -0.0841 -2.3992 -0.9009 -0.0469 ...
#>   .. ..$ x2   : num [1:10] 0.3142 -3.3107 0.0099 -0.4048 1.3658 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.261 -1.568 -0.375 0.193 1.764 ...
#>   .. ..$ x2   : num [1:10] -1.649 2.708 -0.868 -0.61 0.37 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.629 -2.399 0.79 0.412 0.152 ...
#>   .. ..$ x2   : num [1:10] -0.1395 0.0099 1.2269 -0.0186 -0.284 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.41 -0.261 -0.779 -1.277 -0.768 ...
#>   .. ..$ x2   : num [1:10] -1.276 0.286 0.975 -1.472 -2.102 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.34 -0.18 -1.33 1.12 2.15 ...
#>   .. ..$ x2   : num [1:10] -0.972 0.16 -1.814 -1.152 -1.829 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.626 0.3 -0.319 0.619 -2.495 ...
#>   .. ..$ x2   : num [1:10] -0.0422 1.7971 -0.5012 0.3142 0.9231 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.854 -0.773 0.441 1.871 -0.464 ...
#>   .. ..$ x2   : num [1:10] -0.99 0.536 0.972 -1.049 -0.535 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0377 -0.2607 2.1499 -0.084 0.8517 ...
#>   .. ..$ x2   : num [1:10] 0.192 0.286 -1.829 -0.708 -0.947 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (6f541f2b71b4ca9983f4649e9c80efc5-19); on 6f541f2b71b4ca9983f4649e9c80efc5@runnervmvrwv9<7145>]
