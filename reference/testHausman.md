...
#>  eta1                      -0.3000      0.0977   -3.0706    0.0021
#>  eta2                       0.4999      0.0912    5.4833    0.0000
#>  eta6                       0.2501      0.1200    2.0833    0.0372
#>  Resid_eta6                 0.9784      0.2413    4.0545    0.0001
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0523    9.5514    0.0000
#>  eta4                       0.2501      0.0592    4.2241    0.0000
#>  eta5                       0.5001      0.1067    4.6875    0.0000
#>  Resid_eta5                -0.0056      0.1410   -0.0396    0.9684
#> ________________________________________________________________________________
```
