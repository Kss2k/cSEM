...
#>  eta1                      -0.3000      0.1329   -2.2576    0.0240
#>  eta2                       0.4999      0.0975    5.1256    0.0000
#>  eta6                       0.2501      0.1471    1.7007    0.0890
#>  Resid_eta6                 0.9784      0.2867    3.4130    0.0006
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0567    8.8143    0.0000
#>  eta4                       0.2501      0.0604    4.1372    0.0000
#>  eta5                       0.5001      0.1104    4.5303    0.0000
#>  Resid_eta5                -0.0056      0.1406   -0.0397    0.9683
#> ________________________________________________________________________________
```
