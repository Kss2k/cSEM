...
#>  eta1                      -0.3000      0.1078   -2.7835    0.0054
#>  eta2                       0.4999      0.1003    4.9817    0.0000
#>  eta6                       0.2501      0.1221    2.0475    0.0406
#>  Resid_eta6                 0.9784      0.2331    4.1973    0.0000
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0612    8.1635    0.0000
#>  eta4                       0.2501      0.0566    4.4211    0.0000
#>  eta5                       0.5001      0.1030    4.8574    0.0000
#>  Resid_eta5                -0.0056      0.1299   -0.0430    0.9657
#> ________________________________________________________________________________
```
