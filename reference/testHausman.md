...
#>  eta1                      -0.3000      0.0905   -3.3153    0.0009
#>  eta2                       0.4999      0.0865    5.7780    0.0000
#>  eta6                       0.2501      0.1155    2.1656    0.0303
#>  Resid_eta6                 0.9784      0.2062    4.7455    0.0000
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0540    9.2489    0.0000
#>  eta4                       0.2501      0.0516    4.8507    0.0000
#>  eta5                       0.5001      0.0997    5.0164    0.0000
#>  Resid_eta5                -0.0056      0.1338   -0.0417    0.9667
#> ________________________________________________________________________________
```
