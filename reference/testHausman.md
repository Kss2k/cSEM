...
#>  eta1                      -0.3000      0.1037   -2.8937    0.0038
#>  eta2                       0.4999      0.0808    6.1833    0.0000
#>  eta6                       0.2501      0.1145    2.1843    0.0289
#>  Resid_eta6                 0.9784      0.2689    3.6394    0.0003
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0567    8.8219    0.0000
#>  eta4                       0.2501      0.0636    3.9351    0.0001
#>  eta5                       0.5001      0.1078    4.6375    0.0000
#>  Resid_eta5                -0.0056      0.1412   -0.0395    0.9685
#> ________________________________________________________________________________
```
