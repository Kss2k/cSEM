...
#>  eta1                      -0.3000      0.0814   -3.6847    0.0002
#>  eta2                       0.4999      0.0993    5.0336    0.0000
#>  eta6                       0.2501      0.1202    2.0811    0.0374
#>  Resid_eta6                 0.9784      0.2584    3.7865    0.0002
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0573    8.7188    0.0000
#>  eta4                       0.2501      0.0637    3.9263    0.0001
#>  eta5                       0.5001      0.0909    5.4998    0.0000
#>  Resid_eta5                -0.0056      0.1147   -0.0487    0.9612
#> ________________________________________________________________________________
```
