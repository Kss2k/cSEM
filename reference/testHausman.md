...
#>  eta1                      -0.3000      0.1117   -2.6855    0.0072
#>  eta2                       0.4999      0.0948    5.2722    0.0000
#>  eta6                       0.2501      0.1265    1.9774    0.0480
#>  Resid_eta6                 0.9784      0.2566    3.8131    0.0001
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0544    9.1844    0.0000
#>  eta4                       0.2501      0.0514    4.8622    0.0000
#>  eta5                       0.5001      0.1017    4.9176    0.0000
#>  Resid_eta5                -0.0056      0.1405   -0.0397    0.9683
#> ________________________________________________________________________________
```
