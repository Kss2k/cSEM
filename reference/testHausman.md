...
#>  eta1                      -0.3000      0.1117   -2.6858    0.0072
#>  eta2                       0.4999      0.0914    5.4713    0.0000
#>  eta6                       0.2501      0.1468    1.7031    0.0885
#>  Resid_eta6                 0.9784      0.2965    3.2994    0.0010
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0511    9.7749    0.0000
#>  eta4                       0.2501      0.0577    4.3363    0.0000
#>  eta5                       0.5001      0.1038    4.8172    0.0000
#>  Resid_eta5                -0.0056      0.1304   -0.0428    0.9658
#> ________________________________________________________________________________
```
