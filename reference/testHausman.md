...
#>  eta1                      -0.3000      0.1027   -2.9199    0.0035
#>  eta2                       0.4999      0.0849    5.8894    0.0000
#>  eta6                       0.2501      0.1314    1.9026    0.0571
#>  Resid_eta6                 0.9784      0.2992    3.2702    0.0011
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0575    8.6863    0.0000
#>  eta4                       0.2501      0.0657    3.8058    0.0001
#>  eta5                       0.5001      0.1022    4.8927    0.0000
#>  Resid_eta5                -0.0056      0.1455   -0.0384    0.9694
#> ________________________________________________________________________________
```
