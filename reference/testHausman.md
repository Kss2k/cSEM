...
#>  eta1                      -0.3000      0.1362   -2.2028    0.0276
#>  eta2                       0.4999      0.0914    5.4668    0.0000
#>  eta6                       0.2501      0.1449    1.7265    0.0843
#>  Resid_eta6                 0.9784      0.3385    2.8909    0.0038
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0574    8.7077    0.0000
#>  eta4                       0.2501      0.0557    4.4900    0.0000
#>  eta5                       0.5001      0.0986    5.0712    0.0000
#>  Resid_eta5                -0.0056      0.1597   -0.0350    0.9721
#> ________________________________________________________________________________
```
