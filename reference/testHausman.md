...
#>  eta1                      -0.3000      0.1306   -2.2975    0.0216
#>  eta2                       0.4999      0.0859    5.8225    0.0000
#>  eta6                       0.2501      0.1607    1.5558    0.1198
#>  Resid_eta6                 0.9784      0.3084    3.1729    0.0015
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0531    9.4058    0.0000
#>  eta4                       0.2501      0.0535    4.6742    0.0000
#>  eta5                       0.5001      0.0885    5.6539    0.0000
#>  Resid_eta5                -0.0056      0.1310   -0.0426    0.9660
#> ________________________________________________________________________________
```
