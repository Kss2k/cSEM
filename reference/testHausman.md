...
#>  eta1                      -0.3000      0.0984   -3.0474    0.0023
#>  eta2                       0.4999      0.0971    5.1483    0.0000
#>  eta6                       0.2501      0.1191    2.0990    0.0358
#>  Resid_eta6                 0.9784      0.2783    3.5157    0.0004
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0585    8.5445    0.0000
#>  eta4                       0.2501      0.0585    4.2773    0.0000
#>  eta5                       0.5001      0.1013    4.9392    0.0000
#>  Resid_eta5                -0.0056      0.1203   -0.0464    0.9630
#> ________________________________________________________________________________
```
