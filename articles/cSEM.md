...
```
    ...
    ##   eta2 ~ eta1      0.6713      0.0453   14.8078    0.0000 [ 0.5897; 0.7516 ] 
    ##   eta3 ~ eta1      0.4585      0.0848    5.4096    0.0000 [ 0.2810; 0.6244 ] 
    ##   eta3 ~ eta2      0.3052      0.0870    3.5064    0.0005 [ 0.1451; 0.4959 ] 
    ## 
    ## Estimated loadings:
    ## ===================
    ##                                                              CI_percentile   
    ##   Loading        Estimate  Std. error   t-stat.   p-value         95%        
    ##   eta1 =~ y11      0.6631      0.0419   15.8088    0.0000 [ 0.5820; 0.7427 ] 
    ##   eta1 =~ y12      0.6493      0.0411   15.7784    0.0000 [ 0.5658; 0.7286 ] 
    ##   eta1 =~ y13      0.7613      0.0320   23.8064    0.0000 [ 0.7030; 0.8245 ] 
    ##   eta2 =~ y21      0.5165      0.0517    9.9829    0.0000 [ 0.4022; 0.6084 ] 
    ##   eta2 =~ y22      0.7554      0.0369   20.4703    0.0000 [ 0.6778; 0.8154 ] 
    ##   eta2 =~ y23      0.7997      0.0381   21.0073    0.0000 [ 0.7163; 0.8639 ] 
    ##   eta3 =~ y31      0.8223      0.0331   24.8519    0.0000 [ 0.7600; 0.8875 ] 
    ##   eta3 =~ y32      0.6581      0.0401   16.4114    0.0000 [ 0.5784; 0.7349 ] 
    ##   eta3 =~ y33      0.7474      0.0389   19.2320    0.0000 [ 0.6723; 0.8216 ] 
    ## 
    ## Estimated weights:
    ## ==================
    ##                                                              CI_percentile   
    ##   Weight         Estimate  Std. error   t-stat.   p-value         95%        
    ##   eta1 <~ y11      0.3956      0.0220   17.9890    0.0000 [ 0.3513; 0.4372 ] 
    ##   eta1 <~ y12      0.3873      0.0212   18.3024    0.0000 [ 0.3462; 0.4301 ] 
    ##   eta1 <~ y13      0.4542      0.0203   22.4101    0.0000 [ 0.4167; 0.4950 ] 
    ##   eta2 <~ y21      0.3058      0.0274   11.1462    0.0000 [ 0.2449; 0.3533 ] 
    ##   eta2 <~ y22      0.4473      0.0216   20.7335    0.0000 [ 0.4052; 0.4920 ] 
    ##   eta2 <~ y23      0.4735      0.0211   22.4611    0.0000 [ 0.4309; 0.5159 ] 
    ##   eta3 <~ y31      0.4400      0.0181   24.3510    0.0000 [ 0.4060; 0.4786 ] 
    ##   eta3 <~ y32      0.3521      0.0184   19.1814    0.0000 [ 0.3124; 0.3872 ] 
    ##   eta3 <~ y33      0.3999      0.0195   20.4643    0.0000 [ 0.3631; 0.4364 ] 
    ## 
    ## ------------------------------------ Effects -----------------------------------
    ## 
    ...
    ##   eta2 ~ eta1       0.6713      0.0453   14.8078    0.0000 [ 0.5897; 0.7516 ] 
    ##   eta3 ~ eta1       0.6634      0.0416   15.9565    0.0000 [ 0.5825; 0.7404 ] 
    ##   eta3 ~ eta2       0.3052      0.0870    3.5064    0.0005 [ 0.1451; 0.4959 ] 
    ## 
    ...
    ##   eta3 ~ eta1          0.2049      0.0576    3.5541    0.0004 [ 0.0976; 0.3277 ] 
    ## ________________________________________________________________________________
...
```
    ...
    ## 99%L   0.5560075   0.2420351  0.08093994
    ## 99%U   0.7895661   0.6786802  0.52927442
    ## 95%L   0.5839288   0.2942347  0.13453698
    ## 95%U   0.7616449   0.6264806  0.47567738
    ## 
    ## $CI_percentile
    ##      eta2 ~ eta1 eta3 ~ eta1 eta3 ~ eta2
    ## 99%L   0.5511905   0.2552872  0.07691836
    ## 99%U   0.7710609   0.6682855  0.53078269
    ## 95%L   0.5896947   0.2809548  0.14514789
    ## 95%U   0.7515940   0.6243568  0.49588901
